    ...
    return ThemeData(
      ...
      extensions: [
        AppThemeExtension(
          ...
          greenGlow: AppColors.neonGlow(color: AppColors.neonBlue),
          cyanGlow: AppColors.neonGlow(color: AppColors.vibrantPurple),
          pinkGlow: AppColors.neonGlow(color: AppColors.hotMagenta),
